...
Thai–English NLP classification using multilingual DistilBERT for trust, safety and off-platform communication detection.
Multilingual Trust & Safety NLP
...
Thai or English input message

label

0 for negative or 1 for potential violation
